...
$s_cost=abs(intval($_REQUEST['cost']));
$s_item=$_REQUEST['itemsell'];
$s_delete=$_REQUEST['delete'];
$s_doit=$_REQUEST['doit'];
$s_collect=$_REQUEST['collect'];
$time=time();

$itmlist = unserialize($char['itmlist']);

// SELECT AMOUNT TO SELL FOR
if (!($s_cost > 0) && $_GET[sellit] && $itmlist[$s_item][0] && $location_array[$char['location']][3])
{
include('header.htm');
...
if ($s_cost && $numchar < 25 && $location_array[$char['location']][3])
{
$itmlist = unserialize($char['itmlist']);
...
if ($itmlist[$s_item][3] != -1 && $itmlist[$s_item][3] != -2 && $itmtype != 8 && $itmlist[$s_item][0] != '')
{
$itmlist[$s_item][3] = -1;
$id = $char[id];
...
<tr><td width="25"></td><td width="200"><font class="littletext"><b><center>Item</td><td width="100"><font class="littletext"><b><center>Cost</b></td><td width="100"><font class="littletext"><center><b>Location</b></td><td width="50"></td><td width="50"><font class="littletext"><center><b>remove</b></td><td width="25"></td></tr>
</table>
<?php
echo $div_img;
$x=0;
...
<tr>
<td width="25"></td>
<td width="200"><font class="foottext"><center><b><A HREF="javascript:popUp('itemstat.php?<?php echo "base=".$listchar[base]."&prefix=".$listchar[prefix]."&suffix=".$listchar[suffix]; ?>')"><?php echo $listchar['name']; ?></a></b></td><td width="100"><font class="foottext"><center><?php echo number_format($listchar['cost']); ?> g</center></td><td width="100"><font class="foottext"><center><?php echo str_replace('-ap-','&#39;',$listchar['location']); /*ucwords($item_type[$item_base[$listchar['base']][1]]);*/ ?></td><td width="50"></td><td width="50" valign="middle" align="center"><font class="foottext"><?php if ($char['location']==$listchar['location']) { ?><a href="charshop.php?doit=1&delete=<?php echo $listchar['id']; ?>"><img border="0" src="images/delete.gif"></a><?php } ?></td>
<td width="25"></td>
</tr>
</table>
<?php
