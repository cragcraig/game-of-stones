...
<html>
	...
	<body bgcolor="black">
		...
		<br>
		<table border='0' cellpadding='0' cellspacing='0'><tr><td><img src='tools/scale.gif'></td><td class="foottext">&nbsp;&nbsp;[<a href="javascript:void();" onClick="document.getElementById('theForm').submit();">Search Market</a> | <a href="/<?php echo $subfile; ?>/charshop.php?time=<?php echo time(); ?>" target="_parent">View your Shop</a>]</td></tr></table>
	</body>
	<footer>
	</footer>
</html>
