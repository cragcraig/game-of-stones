...
if ($message == '')
{
	if ($lengtharray==1) $message = "One message stored  (".intval(100*$lengtharray/50)."%)";
	else $message = "$lengtharray messages stored  (".intval(100*$lengtharray/50)."%)";
}
...
<form method="post" action="notesdel.php">
<?php
$x=$resultnumb;
...
{
?>
<table cellspacing="0" border="0" cellpadding="0" width="600"><tr><td width="150"><font class="littletext"><center><b>Name</b></td><td><font class="littletext"><center><b>Message</b></td></tr></table>
<?php echo $div_img; ?>
<br>
<?php
while ($x < $lengtharray)
...
$curnote=str_replace("note=","time=".time()."&note=$y",$curnote);
...
$x ++;
if ($x >= $resultnumb + 10) {break;}
}

// END DRAWING MESSAGES
}
else echo "<br><br><b>-No Messages-</b>";
?>
...
{
// NEXT PAGE LINKS
$resultnumb1=$resultnumb + 10;
$resultnumb2=$resultnumb - 10;
echo "<table border=0 width=400><tr><td width=150>";

if ($resultnumb > 0)
{
?>
<p align="left"><font class="littletext"><a href="notes.php?resultnumb=<?php echo "$resultnumb2&time=$time"; ?>">&#60;&#60; Previous</a>
<?php
}
?>
</td><td width="100"><font class="littletext"><center>Page <?php echo (($resultnumb / 10) + 1); ?></td><td width="150">
<?php
if ($resultnumb + 10 < $lengtharray)
{
?>
<p align="right"><font class="littletext"><a href="notes.php?resultnumb=<?php echo "$resultnumb1&time=$time"; ?>">Next &#62;&#62;</a>
<?php
}
echo "</td></tr></table><br>";
